...
class MainActivity : AppCompatActivity() {
    var responseModel:MainResponseModel = MainResponseModel("", ArrayList())
    ...
    private fun setResponseOfScreen() {
        ...
        responseModel.title=responseTitle
        val typeRow = object : TypeToken<List<ListModel>>() {}.type
        responseModel.rows= gson.fromJson(responseRows,typeRow)
